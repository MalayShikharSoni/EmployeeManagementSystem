...
const LandingPage: React.FC = () => {
  ...
  const BarSVG = ({ className }: { className?: string }) => (
    <svg className={`${className} bg-transparent mx-2`} width="20" height="auto" viewBox="0 0 349 520" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <div className="mainLandingPage">
      ...
      <div ref={pageRef} className="landing-page bg-[#cec0ad] w-screen h-screen opacity-0">
        ...
        <div className="pt-[16vh] bg-transparent flex flex-col justify-center items-center h-full w-full relative">
          <div className="WORK bg-transparent max-sm:px-[6vw]" style={{ mixBlendMode: "difference" }}>
            <Image src="/assets/WORK.svg" alt="WORK" width={800} height={200} className="bg-transparent" style={{ height: '20vh', width: 'auto' }} />
          </div>
          <div className="WAVE mt-[3vh] bg-transparent mb-30 max-sm:px-[6vw] max-sm:mt-[-5vh]" style={{ mixBlendMode: "difference" }}>
            <Image src="/assets/WAVE.svg" alt="WAVE" width={800} height={200} className="bg-transparent" style={{ height: '20vh', width: 'auto' }} />
          </div>

          <div className="blackbox flex justify-between items-center bg-[#cec0ad] mt-16 w-[80vw] h-[130px]" style={{ mixBlendMode: "difference" }}>
            <div className="mx-[1rem] bg-[#0b7494] rounded-md w-[35%] h-[80%]" style={{ mixBlendMode: "normal" }}>
              <div className="relative flex items-center justify-center bg-transparent w-[100%] h-[100%] overflow-hidden" style={{ isolation: "isolate" }}>
                <svg className="bg-transparent w-[110%] h-auto self-center" viewBox="10 0 450 200" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="flex items-center gap-10 bg-[#cec0ad] h-full w-full overflow-hidden">
              {["EFFICIENT AMPLITUDE", "PRODUCTIVE PHASE", "FLAWLESS FREQUENCY", "EFFICIENT AMPLITUDE", "PRODUCTIVE PHASE"].map((text, i) => (
                <React.Fragment key={i}>
                  <div className="flex marque flex-shrink-0 text-black font-bold text-5xl bg-[#cec0ad] h-full justify-center items-center max-sm:text-[30px]">{text}</div>
                  <div className="flex marque flex-shrink-0 bg-[#cec0ad] h-full justify-center items-center">
                    <Image src="/assets/Waveform.svg" alt="Waveform" width={100} height={50} className="bg-transparent" style={{ height: '7vh', width: 'auto' }} />
                  </div>
                </React.Fragment>
              ))}
            </div>
          ...
          <div className="section flex flex-row items-center justify-center w-[300vw] h-screen bg-[#cec0ad]">
            ...
            <div className="relative h-screen w-[100vw] bg-transparent">
              <div className="flex flex-row items-center justify-center bg-transparent absolute bottom-[10%] left-[33%] transform -translate-x-1/2 -translate-y-1/2 max-sm:left-[50%]">
                <div className="part1Text bg-transparent text-black italic font-black text-xl max-sm:text-[15px]">STREAMLINE TASKS</div>
                <BarSVG className="part1SVG" />
                <div className="part1Text bg-transparent text-black italic font-black text-xl max-sm:text-[15px]">TRACK PROGRESS</div>
                <BarSVG className="part1SVG" />
                <div className="part1Text bg-transparent text-black italic font-black text-xl max-sm:text-[15px]">ENHANCE PRODUCTIVITY</div>
              </div>
            </div>
            ...
            <div className="flex flex-row h-screen w-[100vw] bg-transparent">
              <div className="flex flex-col h-full w-[50vw] justify-center bg-transparent">
                <div className="part2Text bg-transparent font-black text-[#ad9676] text-9xl max-sm:text-6xl">As an</div>
                <div className="part2Text bg-transparent font-black text-[#ad9676] text-9xl max-sm:text-4xl">Employee</div>
                {["Interactive Status Update", "Tagged Task Categorization", "Due Date Tracking"].map((text, i) => (
                  <div key={i} className={`flex flex-row gap-2 bg-transparent ${i === 0 ? 'mt-[1vh]' : 'mt-[2vh]'} translate-y-[7vh]`}>
                    <BarSVGBrown className="part2SVG" />
                    <div className="part2Points bg-transparent font-bold text-[#efeae4] text-3xl max-sm:text-xl">{text}</div>
                  </div>
                ))}
              </div>
              <div className="flex flex-col h-full w-[50vw] justify-center bg-transparent">
                <div className="popup relative bg-[#ad9676] w-[400px] h-[300px] rounded-se-[50px] rounded-es-[50px] rounded-ee-[50px] p-5 max-sm:w-[210px] max-sm:h-[220px]">
                  ...
                  <div className="popupText bg-transparent font-black text-blue-300 text-5xl max-sm:text-2xl">Accept</div>
                  <div className="popupText bg-transparent font-black text-yellow-300 text-5xl max-sm:text-2xl">Track</div>
                  <div className="popupText bg-transparent font-black text-green-300 text-5xl max-sm:text-2xl">Complete</div>
                  <div className="popupText bg-transparent font-black text-red-300 text-3xl max-sm:text-xl">(or Decline)</div>
                  <div className="popupText bg-transparent font-black text-[#efeae4] text-6xl max-sm:text-3xl">your tasks</div>
                </div>
              </div>
            </div>
            ...
            <div className="part3 flex flex-col justify-start h-[100vh] w-[100vw] bg-transparent">
              <div className="flex flex-row justify-between h-[75vh] bg-transparent">
                <div className="flex flex-col h-full items-start justify-start bg-transparent ml-[7vw]">
                  <div className="part2Text bg-transparent font-black text-[#ad9676] text-9xl mt-[150px] ml-[3vw] max-sm:text-6xl">As the</div>
                  <div className="part2Text bg-transparent font-black text-[#ad9676] text-9xl ml-[3vw] max-sm:text-6xl">Admin</div>
                </div>
              ...
              <div className="part3 flex justify-around items-center h-[25vh] w-[100vw] bg-transparent">
                <div className="bg-transparent text-white font-bold text-3xl translate-x-[8%] z-10 max-sm:text-[20px]">Assign Tasks to Employees</div>
                <div className="bg-transparent text-white font-bold text-3xl z-10 max-sm:text-[20px]">View Employee Progress</div>
                <div className="bg-transparent text-white font-bold text-3xl z-10 max-sm:text-[20px]">Recieve Updates Dynamically</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <Link href="/main">
        <div className="part4 section flex flex-row items-center justify-center w-[100vw] h-[30vh] bg-[#cec0ad]">
          <div className="getStartedDivs flex items-center justify-center bg-[#ad9676] w-[300px] h-[100px] rounded-es-[35px]">
            <div className="bg-transparent text-[#cec0ad] font-black text-3xl">GET STARTED</div>
          </div>
