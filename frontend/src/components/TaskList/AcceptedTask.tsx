  ...
  return (
    <div ref={taskBoxRef} className={styles.taskCard}>
      <div className={styles.cardContent}>
        ...
        <div ref={titleRef} className={`beforeHover ${styles.titleAccepted}`}>
          {data?.title}
        </div>
      ...
      <div ref={buttonRef} className={`afterHover ${styles.buttonOverlayCenter}`}>
        <button onClick={handleCompleteTask} disabled={isProcessing} className={styles.completeBtn}>
          Check Off
        </button>
        <button onClick={handleDeclineTask} disabled={isProcessing} className={styles.declineBtn}>
          Decline
        </button>
      </div>
