    ...
    tl6.to(".logo-container", {
      ...
      onComplete: () => {
        ...
        gsap.to(pageRef.current, {
          //  Use ref to fade in the landing page
          opacity: 1,
          duration: 1.2,
          ease: "power2.out",
        });
              ...
              >
                ...
                >
                  <path
                    ...
                    ref={pathRef}
                    d="M 10 100 L 100 100 L 120 50 L 140 150 L 160 100 L 300 100 L 320 50 L 340 150 L 360 100 L 490 100"
                    stroke="white"
                    strokeWidth="9"
                    fill="none"
                  />
          ...
          <div className="section flex flex-row items-center justify-center w-[300vw] h-screen bg-[#cec0ad]">
            ...
            <div className="relative h-screen w-[100vw] bg-transparent">
              <div className="flex flex-row items-center justify-center bg-transparent absolute bottom-[10%] left-[33%] transform -translate-x-1/2 -translate-y-1/2 max-sm:left-[50%]">
                ...
                >
                  <path
                    d="M24 123V407M170.5 24V249.5V496M324.5 123V407"
                    stroke="#FF4902"
                    stroke-width="48"
                    stroke-linecap="round"
                  />
