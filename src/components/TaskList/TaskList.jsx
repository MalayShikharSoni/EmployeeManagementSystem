      ...
      >
        {tasks?.some((task) => task.newTask) ? (
          ...
          <div
            ...
            onMouseEnter={() => {
              setTaskLengthChange((prev) => prev + 1);
          ...
          >
            <div className="relative bg-[#ded5c8] rounded-se-[35px] rounded-es-[35px] rounded-ee-[35px] w-[320px] h-[300px] ">
              ...
              <div
                ref={popupTextRef}
                className="popupText absolute w-auto bg-transparent top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] text-center text-5xl font-bold text-[#ad9676] opacity-0"
              >
                No Such Tasks
              </div>
            </div>
